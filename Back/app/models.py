...
class User(Base):
    ...
    # Relacionamentos
    anime_statuses = relationship("UserAnimeStatus", back_populates="user", cascade="all, delete-orphan")
...
class Anime(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    external_id = Column(Integer, unique=True, index=True, nullable=False)  # id do AniList
    ...
    user_statuses = relationship("UserAnimeStatus", back_populates="anime", cascade="all, delete-orphan")
